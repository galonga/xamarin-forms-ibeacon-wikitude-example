var World = {
	...
	createOverlays: function createOverlaysFn() {
		...
		*/
		this.modelLok = new AR.Model("augmentation/models/Lok.wt3", {
			onLoaded: this.loadingStep,
			scale: {
				x: 0.02,
				y: 0.02,
		...
		this.animation1 = new AR.ModelAnimation(this.modelLok, "Lok_animation");
	...
	loadingStep: function loadingStepFn() {
		if (!World.loaded && World.tracker.isLoaded() && World.modelLok.isLoaded()) {
			World.loaded = true;
