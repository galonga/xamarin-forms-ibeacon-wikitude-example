var World = {
	...
	createOverlays: function createOverlaysFn() {
		...
		*/
		this.tracker = new AR.Tracker("wtc/targetcollections.wtc", {
		...
		*/
		this.modelTisch = new AR.Model("augmentation/models/cat.wt3", {
			onLoaded: this.loadingStep,
			scale: {
				x: 0.035,
				y: 0.035,
		...
		this.animation1 = new AR.ModelAnimation(this.modelTisch, "1_animation");
	...
	loadingStep: function loadingStepFn() {
		if (!World.loaded && World.tracker.isLoaded() && World.modelTisch.isLoaded()) {
			World.loaded = true;
