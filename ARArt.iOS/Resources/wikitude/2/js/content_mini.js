var World = {
	...
	createOverlays: function createOverlaysFn() {
		...
		*/
		this.modeWagen = new AR.Model("augmentation/models/Lastkarren.wt3", {
			onLoaded: this.loadingStep,
			scale: {
				x: 0.0085,
				y: 0.0085,
		...
		this.animation1 = new AR.ModelAnimation(this.modeWagen, "Lastkarren_animation");
	...
	loadingStep: function loadingStepFn() {
		if (!World.loaded && World.tracker.isLoaded() && World.modeWagen.isLoaded()) {
			World.loaded = true;
